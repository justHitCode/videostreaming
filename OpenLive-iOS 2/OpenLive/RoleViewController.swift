...
class RoleViewController: UIViewController {
    ...
    @IBOutlet weak var audienceheightconstraint: NSLayoutConstraint!
    
    @IBOutlet weak var viewtobehidden: UIView!
    override func viewDidLoad() {
        super.viewDidLoad()
        if session_admin_flagstring1 == "attendee"{
            viewtobehidden.isHidden=true
            audienceheightconstraint.constant=0
        }else{
            viewtobehidden.isHidden=false
             audienceheightconstraint.constant=150
        }
    }
